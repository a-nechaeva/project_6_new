...
import ifmo.commands.implemented.*;

import java.io.Serializable;
public enum CommandType implements Serializable{
    CLEAR(ClearCommand.class, "clear: clear the collection"),
    //TODO:   COUNT_BY_NUMBER_OF_PARTICIPANTS(CountByNumberOfParticipantsCommand.class, "count_by_number_of_participants numberOfParticipants : вывести количество элементов, значение поля numberOfParticipants которых равно заданному"),
 ...
 //TODO:   GROUP_COUNTING_BY_NAME(GroupCountingByNameCommand.class, "group_counting_by_name : сгруппировать элементы коллекции по значению поля name, вывести количество элементов в каждой группе"),

 //   PRINT_ASCENDING(PrintAscendingCommand.class, "print_ascending: print the elements of the collection in ascending order"),
 //TODO:   PRINT_FIELD_DESCENDING_SINGLES_COUNT_COMMAND(PrintFieldDescendingSinglesCountCommand.class, "print_descending_singles_count_command: print the elements of the collection in descending order based on number of singles"),
    ...
    REMOVE_GREATER(RemoveGreaterCommand.class, "remove_greater <numberOfParticipants>: remove from the collection all elements exceeding the specified"),
    REMOVE_LOWER(RemoveLowerCommand.class, "remove_lower <numberOfParticipants>: remove from the collection all elements less the specified"),
    //TODO:   REMOVE_GREATER_KEY(RemoveGreaterKeyCommand.class, "remove_greater_key: remove from the collection all elements exceeding the specified"),
